...
**Home page**
  ...
  **Search**
  ## Search có phải là 1 page mới?
  ## Search "ipad" => danh mục bên trái có hợp lý?
  ## ko kết quả 1 page riêng
  ## sản phẩm gợi ý ra trang detail
  **Search**

  **Card (giỏ hàng)**
  ## Phân trang ở giỏ hàng? ko có
  ## Có cho thay đổi thuốc tính ngay trong giỏ hàng hay không? có
  **Card (giỏ hàng)**

  **Banner**
  ## Thống nhất phần dots slide ở banner có bấm chuyển slide được không? nên là không vì đã vuốt được và có btn next rồi. không bấm
  ## Chữ ở banner là ảnh hay chữ riêng? ảnh
  ## 4 mục dưới banner có bấm được không?ko
  ## Khi next slide có cần hiệu ứng chữ gì không?
  ## Có thể gắn link
  **Banner**

  **Card product**
  ## Những cái không có danh mục thì card của nó hiện như nào?
  ## Tên sản phầm hơn 2 dòng? sẽ để 3 chấm
  ## Hover vào card đơn giản như vậy thôi? đúng
  **Card product**

  **Popup add to card**
  ## Khi add sản phẩm có bắt chọn option không? hay sẽ chọn mặc định options đầu tiên? 
  ## Tên sản phẩm dài hơn 2 dòng?
  ## Nên hiện đã bán 35/60 ? đã bỏ ở ngoài
  ## Popup product đã bán và giảm giá khi không có thì như nào?
  ## Slide thumb active có gì khác biệt không?
  ## Popup chưa có bấm xem chi tiết khi add sản phẩm? sẽ bấm vào title
  **Popup add to card**
...
**Flash sale**
  ...
  **Flash voucher**
  ...
  ## Load more dẫn ra danh mục sản phẩm (flash sale)? đúng
...
**Pre Oder**
  ...
  **Sản phẩm nổi bật**
  ## Button chưa có hiệu ứng hover? hover zoom ảnh
  ## Khung ảnh sẽ nhỏ như trong thiết kế nếu không được xoá nền? Để như kích thước design
  **Sản phẩm nổi bật**
  ...
  **Sản phẩm sắp ra mắt**
  ## button +16 sản phẩm => click vào hiện thêm
  ## Không có giới hạn sản phẩm preoder?
  ## Preoder vẫn có giá giảm? Nếu không có thì thiết kế như nào? vẫn có giá giảm
  **Sản phẩm sắp ra mắt**

  **Astromazing cam kết**
  ## Bấm vào thì đi đâu? Bấm cả 2 bên?Link cả khung => chuyển đến bài viết chính sách
  **Astromazing cam kết**

  **Slide**
  ## Video chỉ play và hiển thị trong khung điện thoại
  ## Button hover đồng bộ
  **Slide**
...
**Chi tiết Pre Oder**
  **Preview sản phẩm**
  ## Có xem được chi tiết quà tặng không?không
  ## Thấy trước có design popup combo quà tặng đã bỏ đi rồi?bỏ
  ## Dropdown phần gửi yêu cầu chưa gắn prototype?Close như nào? nên có button save hay close không?bấm ra ngoài hoặc bấm lại sẽ tắt
  ## Khách hàng chỉ VN (+84)?
  ## Line xám phía dưới btn gửi yêu cầu là gì?
  ## Btn gửi yêu cầu hover có hiệu ứng gì không
  ## Placeholder Họ tên - sdt hay số điện thoại ...? họ tên - số điện thoại - phân loại hàng
  ## Popup submit form ? bấm ra ngoài overlay sẽ tự tắt bg: black 0.2
  **Preview sản phẩm**
**Chi tiết Pre Oder**

**Danh mục sản phẩm**
  ## Sắp xếp gắn prototype sai?đã gắn lại
  ## Khi bấm vào flash sale thiết kế card như nào?
  ## Popup hover vào ngang bằng
**Danh mục sản phẩm**

**Chi tiết sản phẩm**
  ## Khi rút gọn hoặc đầy đủ, đổi thứ tự "sản phẩm mua kèm phù hợp"? để ở dưới 
  ## Bấm vào +12 voucher sẽ xổ thêm hiện thanh scroll? hay riderect?scroll
  ## Mặc định là đầy đủ hay thu gọn? mặc định rút gọn
**Chi tiết sản phẩm**

**Chi tiết sản phẩm combo**
  ## Sản phẩm combo ở danh muc san pham hiển thị như nào?
  ## Popup chỉnh sửa chi tiết sản phẩm sẽ bỏ button tăng giảm? bỏ tăng giảm
**Chi tiết sản phẩm combo**

**Thanh toán (Thông tin thanh toán)**
  ## Vẫn giữ thanh địa chỉ href?
  ## Tài khoản là (sdt, email)?
  ## "*" đỏ không đồng nhất?
  ## Nếu mua nhiều, có áp dụng voucher cho từng sẩn phẩm không?hay chỉ 1 lần?
  ## Khuyến mãi hạng thành viên?
  ## Có bao nhiêu voucher sẽ áp ụng bấy nhiêu? (Nhập mã voucher)?
  ## Giao hàng tiêu chuẩn, phí ship lây ở đâu hay api?
  ## Hiện 4 voucher nổi bật chưa lưu?scroll 1 row
  ## Nếu mục Thông tin đơn hàng dài hơn phía bên trái thì xuất hiện scroll?
  ## Validate form? đã có
  ## Button trở về? trở về trang cũ
  ## Thanh toán chuyển khoản sẽ như nào? 
  ## Nên có 1 button đặt làm địa chỉ mặc định hoặc add địa chỉ nhận hàng mới?
...
**Tìm kiếm phụ kiện theo thiết bị**
  ...
  <!-- ## Khi Filter có mất item mặc định đầu tiên như thiết kế? -->
