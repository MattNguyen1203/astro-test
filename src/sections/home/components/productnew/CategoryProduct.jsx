...
export default function CategoryProduct({title = '', href = '/'}) {
  return (
    <div className='bg-white rounded-[0.58565rem] pl-[1.46rem] pr-[0.59rem] container flex justify-between items-center h-[3.51391rem]'>
      <h2 className='font-semibold sub2 text-greyscale-80'>{title}</h2>
      <Link
        href={href}
