...
export default function BannerHome({viewport, isMobile}) {
  const pagination = {
    renderBullet: function (_, className) {
      return `<span class="${className} !w-[5.58rem] !h-[0.21962rem] !bg-[#82828263] xmd:!bg-[rgba(163,163,163,0.63)] !rounded-[0.73206rem] xmd:!w-[0.724rem] xmd:!h-[0.16rem]" ></span>`
    },
  }
  return (
    <article className='h-[29.55447rem] xmd:h-[11.85944rem] container mt-[1.17rem] relative'>
      <Swiper
        id='banner_swiper'
        loop={true}
        spaceBetween={16}
