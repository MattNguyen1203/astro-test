    ...
    <Link
      ...
      className={`${
        index === 11
          ...
          : ''
      } ${className} size-full rounded-[0.58565rem] relative group !overflow-hidden block select-none`}
    >
      <Image
      ...
      />
      <div
        className={`${boxClass} relative z-10 size-full px-[0.59rem] pb-[1.54rem] pt-[0.59rem] flex flex-col justify-between`}
      >
