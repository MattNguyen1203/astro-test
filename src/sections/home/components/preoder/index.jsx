...
export default function PreOder() {
  return (
    <div className='container h-[8.05rem] bg-white relative rounded-[0.87848rem] flex'>
      <div className='relative w-[48.16984rem] h-full'>
          ...
          <div className='relative z-10 size-full rounded-tr-[0.87848rem] rounded-br-[0.87848rem] bg-white before:absolute before:origin-bottom-right before:w-0 before:h-full before:bg-blue-700 before:rounded-tr-[0.87848rem] before:rounded-br-[0.87848rem] group-hover:before:size-full before:transition-all before:duration-700 before:right-0 before:bottom-0 before:opacity-0 group-hover:before:opacity-100 flex justify-end items-center pr-[2.49rem]'>
            ...
            >
              ...
              <div className='flex flex-col'>
                <h3 className='font-bold text-blue-600 transition-all duration-500 h5 group-hover:text-white'>
                  ĐẶT TRƯỚC SẢN PHẨM MỚI
                </h3>
                <span className='mt-[0.59rem] text-blue-600 font-medium group-hover:text-white transition-all duration-500'>
                  iPhone 14 pro max sắp ra mắt
                </span>
              </div>
              <div className='size-[3.51391rem] relative ml-[2.42rem]'>
                <Image
