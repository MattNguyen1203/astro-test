...
const ContentPostDetail = ({data}) => {
  ...
  return (
    <div className=''>
      ...
      >
        <div className='font-medium sub1 text-greyscale-80'>Nội dung chính</div>
        <div className=' w-full md:w-[56.58858rem] h-[0.07321rem] !mt-[0.75rem] bg-[#B7C2CC]'></div>
        <Link
          href='#section1'
          className='th-fl md:w-[55.7101rem] h-[1.75695rem] '
        >
          <div className='cursor-pointer body1 font-normal text-greyscale-40 md:w-[55.7101rem] md:shrink-0 md:self-stretch'>
