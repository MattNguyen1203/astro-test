    ...
    <div className='py-[3.81rem] xmd:pt-[2.34rem] xmd:pb-[3.51rem]'>
      <div className='container rounded-[1.46413rem] bg-white h-[8.56515rem] relative flex md:items-center group md:hover:bg-[#EEB357] transition-all duration-200 select-none xmd:bg-[linear-gradient(44deg,#FFF0D8_52.89%,#FFD797_107.96%)] xmd:pt-[1.1rem] xmd:px-[0.88rem] xmd:pb-[0.73rem] xmd:rounded-[0.58565rem] xmd:flex-col xmd:justify-between xmd:h-[7.9063rem]'>
        ...
        <div className='absolute top-0 left-0 z-0 overflow-hidden size-full rounded-[1.46413rem]'>
          <div className='absolute top-1/2 -translate-y-1/2 right-0 translate-x-1/2 w-[52.34905rem] h-[68.20769rem] pointer-events-none rounded-full bg-[#10273F] rotate-[54.632deg] scale-[10%] md:group-hover:scale-100 md:group-hover:opacity-100 transition-all duration-300 opacity-0'></div>
        </div>
        <Link
          href='/tin-tuc'
        ...
        >
          <span className='font-svnGraphik font-medium transition-all duration-300 block w-fit mr-[0.66rem] sub1 text-greyscale-80 md:group-hover:text-white xmd:text-white xmd:caption1 xmd:font-semibold'>
            Xem Chi Tiết
          </span>
          <Image
