  ...
  return (
    <section className='mt-[1.76rem] container'>
      ...
      <div className='w-full lg:h-[36.01757rem] flex xmd:flex-col'>
        <div className='w-[57.9795rem] xmd:w-[26.28111rem] h-full rounded-[1.1713rem] lg:overflow-hidden lg:mr-[1.83rem] xlg:mr-[1.83rem] flex-shrink-0'>
          <ItemTechnology
            post={posts[0]}
            priority={true}
            className='xlg:relative'
            widthHeightImg='w-[57.9795rem] h-[36.01757rem] xmd:w-[26.28111rem] xmd:h-[16.32613rem]'
            boxClass='pt-[1.83rem] pb-[1.17rem] px-[1.46rem] xmd:p-0 xlg:absolute xlg:top-0 lg:absolute lg:top-0'
          />
        </div>
        <div className='xmd:hidden w-full grid grid-cols-1 grid-rows-2 gap-y-[1.54rem]'>
          <ItemTechnology
            priority={true}
            className='rounded-[1.1713rem] xlg:relative'
            boxClass='!p-[1.17rem]'
            post={posts[1]}
          />
          <ItemTechnology
      ...
      <div className='relative mt-[1.83rem] xmd:w-full h-[17.13031rem] xmd:h-[19rem] overflow-hidden'>
        <div className='xlg:grid xlg:grid-cols-3 lg:grid lg:grid-cols-3 xmd:gap-x-0 gap-x-[0.58565rem] flex h-full xmd:absolute xmd:overflow-auto xmd:top-0 xmd:left-0'>
