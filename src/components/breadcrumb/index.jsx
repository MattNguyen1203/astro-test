...
export default function BreadCrumb({
  ...
  return (
    <div className='flex overflow-hidden w-fit xmd:max-w-full xmd:w-full'>
      <Link
        href={'/'}
        className='flex items-center flex-shrink-0 w-fit xmd:w-fit'
      >
        <svg
          ...
          viewBox='0 0 16 16'
          fill='none'
          className='size-[1.1713rem] mr-[0.29rem] flex-shrink-0'
        >
          <path
        ...
        <span className='font-normal caption1 leading-[100%] text-greyscale-10 whitespace-nowrap'>
          Trang chủ
        </span>
      </Link>
      {categorySlg && (
        ...
        >
          <svg
            ...
            viewBox='0 0 16 16'
            fill='none'
            className='size-[1.1713rem] xmd:absolute xmd:top-1/2 xmd:left-0 xmd:-translate-y-1/2 flex-shrink-0'
          >
            <path
