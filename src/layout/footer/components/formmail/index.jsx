export default function FormEmail() {
  return (
    <div className='flex md:items-center xmd:container xmd:flex-col'>
      ...
      <div className='bg-white w-[18.9582rem] h-[2.63543rem] rounded-[1.46413rem] md:ml-[1.17rem] xmd:rounded-[0.58565rem] xmd:h-[3.22108rem] xmd:w-full xmd:mt-[0.88rem]'></div>
    </div>
  )
}
