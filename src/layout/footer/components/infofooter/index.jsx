  ...
  return (
    <div>
      ...
      <div className='flex items-center mt-[1.17rem]'>
        ...
        <div className='w-[4.1194rem] h-[2.92826rem] rounded-[0.59561rem] bg-white shadow-[7.458px_4.068px_16.271px_0px_rgba(0,0,0,0.04),0px_1.356px_21.695px_0px_rgba(0,0,0,0.04)] flex justify-center items-center mr-[1.46rem]'>
          <Image
